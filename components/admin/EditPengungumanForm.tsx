...
import { updatePengumuman } from "@/src/app/actions/pengumuman";
import { DocumentUpload } from "@/components/admin/dokumen/dokumenUpload";
...
export default function EditPengumumanForm({ initialData }: EditPengumumanFormProps) {
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Perbarui informasi pengumuman yang sudah ada.</p>
        </div>
      </div>
      ...
      <form action={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input 
              ...
              defaultValue={new Date(initialData.tanggal).toISOString().split('T')[0]}
        ...
        <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
          <label className="block text-sm font-semibold text-gray-800 mb-2">Lampiran Dokumen</label>
