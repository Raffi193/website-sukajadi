    ...
    <footer className="bg-gray-900 text-white pt-20 pb-10 font-sans">
      <div className="container mx-auto px-4 md:px-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-lg leading-none font-poppins">
                  Kelurahan Sukajadi
                </h3>
                <p className="text-xs text-gray-400 pt-2">
                  Kecamatan Talang Kelapa, Kabupaten Banyuasin, Provinsi
                  Sumatera Selatan
                </p>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Website resmi Pemerintah Kelurahan Sukajadi. Media komunikasi dan
              transparansi publik untuk mewujudkan pemerintahan yang akuntabel.
            </p>
            <div className="flex gap-4">
              <Link
                href="#"
                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-blue-600 transition-colors text-white"
              >
                <FaFacebook />
              </Link>
              <Link
                href="#"
                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-pink-600 transition-colors text-white"
              >
                <FaInstagram />
              </Link>
              <Link
          ...
          <div>
            <h4 className="font-bold text-lg mb-6 font-poppins border-l-4 border-blue-600 pl-3">
              Jelajahi
            </h4>
            <ul className="space-y-3 text-sm text-gray-400">
              <li>
                ...
                >
                  <FaChevronRight size={10} className="text-blue-600" /> Visi &
                  Misi
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className="hover:text-blue-500 transition flex items-center gap-2"
                >
                  <FaChevronRight size={10} className="text-blue-600" />{" "}
                  Struktur Organisasi
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className="hover:text-blue-500 transition flex items-center gap-2"
                >
                  <FaChevronRight size={10} className="text-blue-600" /> Kabar
                  Desa
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className="hover:text-blue-500 transition flex items-center gap-2"
                >
                  <FaChevronRight size={10} className="text-blue-600" /> Layanan
                  Publik
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className="hover:text-blue-500 transition flex items-center gap-2"
                >
                  <FaChevronRight size={10} className="text-blue-600" /> Galeri
                  Kegiatan
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Jl. Hm Asyik Aqil, Sukomoro, Kec Talang Kelapa, Kabupaten
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center md:text-left flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <p>
            &copy; {new Date().getFullYear()} Pemerintah Kelurahan Sukajadi. Hak
            Cipta Dilindungi.
          </p>
