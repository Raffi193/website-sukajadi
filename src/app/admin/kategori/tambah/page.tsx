...
// Import form client
import CreateKategoriForm from "@/components/admin/kategori/CreateKategoriForm"; 
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="space-y-1">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900">
              Buat <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-indigo-600">Kategori Baru</span>
            </h1>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden relative">
          ...
          <div className="p-8">
             ...
             <div className="flex items-center gap-3 mb-6 pb-6 border-b border-gray-50">
                ...
                <div>
                   <h2 className="text-lg font-bold text-gray-900">Formulir Kategori</h2>
                   <p className="text-sm text-gray-500">Isi detail label kategori di bawah ini.</p>
                </div>
             </div>
