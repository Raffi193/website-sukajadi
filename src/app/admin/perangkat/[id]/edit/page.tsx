...
import EditPerangkatForm from "@/src/components/admin/perangkat/EditPerangkatForm";
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="space-y-1">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900">
              Perbarui{" "}
              <span className="text-transparent bg-clip-text bg-indigo-800">
                Personel
              </span>
            </h1>
          </div>
            ...
            <div className="flex items-center gap-3 mb-8 pb-6 border-b border-gray-50">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Sesuaikan data personel di bawah ini.
                </p>
              </div>
            </div>
