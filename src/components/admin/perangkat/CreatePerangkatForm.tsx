...
import { createPerangkat } from "@/src/actions/perangkat";
import { ImageUpload } from "@/src/components/admin/berita/ImageUpload";
      ...
      <div className="lg:col-span-4 space-y-4">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="mt-4 p-3 bg-blue-50 text-blue-700 text-xs rounded-lg leading-relaxed">
            <strong>Tips:</strong> Gunakan foto formal dengan latar belakang
            polos. Format JPG/PNG, maksimal 2MB.
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="nama"
                  name="nama"
                  placeholder="Contoh: H. Budi Santoso, S.Sos"
                  required
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="jabatan"
                  name="jabatan"
                  placeholder="Contoh: Lurah Sukajadi"
                  required
                  className="pl-9 bg-gray-50/50 border-gray-200 focus:bg-white transition-all"
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-gray-400 mt-1">
                Angka 0 akan tampil paling atas.
              </p>
            </div>
          </div>
